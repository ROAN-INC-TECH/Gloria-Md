...
function defaultData() {
    return {
        ...
        groupMetaCache: {}   // { groupId: { subject, desc } } — utilisé par antigcstatus
    };
}
...
function read() {
    ...
    try {
        ...
        // fusion avec les valeurs par défaut au cas où de nouveaux champs sont ajoutés
...
module.exports = {
    ...
    // --- RÉGLAGES PAR GROUPE (antibot, chatbot, antidemote, antipromote, antigcstatus, autopromote...) ---
    ...
    // --- CACHE NOM/DESCRIPTION DU GROUPE (utilisé par antigcstatus) ---
